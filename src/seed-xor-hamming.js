...
export const split = async (mnemonic, useRandom = false) => {
    ...
    const share1Entropy = useRandom
        ...
        : await utils.getDeterministicEntropyFromMnemonic('Hamming ', mnemonic, 0, 1, 32);
    const share1 = bip39.entropyToMnemonic(share1Entropy);
    const [share2, share3] = hammingBackup(mnemonic, share1);
    return [share1, share2, share3];
};
export const combine = async (share1, share2) => {
